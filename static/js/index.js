...
function calculateFinalPrice() {
    ...
    document.getElementById('finalPrice').value = finalPrice.toLocaleString('fa-IR') + ' تومان';
}
function CopyText(index) {
    ...
    switch(index) {
        case 1:
            textToCopy = document.querySelectorAll('.card-info-value h4')[0].innerText; // Account Name
            break;
        case 2:
            textToCopy = document.querySelectorAll('.card-info-value h4')[1].innerText; // Sort Code
            break;
        case 3:
            textToCopy = document.querySelectorAll('.card-info-value h4')[2].innerText; // Account Number
            break;
        default:
            return;
    }
...
document.addEventListener("DOMContentLoaded",()=>{
    ...
    XBtn.addEventListener("click", () => {
        ...
        // Use animationend to hide the button after the animation
        XBtn.addEventListener("animationend", () => {
